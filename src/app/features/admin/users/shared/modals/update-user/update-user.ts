...
import { GetUserByIdUseCase, GetRolesUseCase, GetDepartmentsUseCase, GetBusinessUnitsUseCase, GetToolsUseCase, UpdateUserUseCase, GetToolTemplatesUseCase } from '../../../../../../core/application/use-cases/users';
...
import { FoxcodeSelect } from "../../../../../../shared";
...
export class UpdateUser implements OnInit, OnDestroy {
  ...
  private getToolsUseCase = inject(GetToolsUseCase);
  ...
  private loadData(): void {
    forkJoin({
      ...
      toolsByBu: this.getToolsUseCase.execute(),
