...
export class UsersRequestService {
  ...
  async getUsers(loading = true) {
    ...
    this.http
      .get<IResponseUsers>(`${this.userURL}/v1/users`)
  ...
  async getRoles(loading = true) {
    ...
    this.http
      .get<IRoles[]>(`${this.userURL}/v1/roles`)
  ...
  async createUser(userData: Partial<ICreateUpdateUser>) {
    ...
    this.http.post(`${this.userURL}/v1/users`, payload).subscribe({
      next: (response) => {
  ...
  async updateUser(userId: string, userData: Partial<ICreateUpdateUser>) {
    ...
    this.http.put(`${this.userURL}/v1/users/${userId}`, payload).subscribe({
      next: (response) => {
