...
export class DtsButton {
  ...
  get buttonClasses(): string {
    const baseClasses = 'inline-flex items-center justify-center font-medium outline-none';
    ...
    const variantMap = {
      ...
      outline: 'bg-transparent border-2 border-[#3a57e8] text-[#3a57e8] hover:bg-[#3a57e8]/5 outline-none active:bg-[#3a57e8]/10'
    };
